...
class TemplateGenerator(ABC):
    ...
    @abstractmethod
    def generate_templates(self, texts_input, n_masks = 2, min_score=0.9, relevant_tags=[]):
        pass
...
class GenericTemplateGeneratorApp1(TemplateGenerator):
    ...
    def generate_templates(self, texts_input, relevant_tags, n_masks = 2):
        ...
        sentences = RankedWordsFilter.apply(sentences)
...
class GenericTemplateGeneratorApp5(TemplateGenerator):
    ...
    def generate_templates(self, texts_input, relevant_tags, n_masks = 2, min_classification_score=0.9):
        ...
        sentences = HighClassificationScoreWordFilter.apply(sentences, self.model, n_masks, min_classification_score)
        print(f':: {len(sentences)} sentences remaining.')
